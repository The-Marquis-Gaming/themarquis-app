      ...
      builder: (context, constraints) {
        ...
        return Column(
          children: [
            Padding(
              padding:
                  const EdgeInsets.only(left: 24, right: 7, top: 17, bottom: 4),
              child: Row(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    gradient: LinearGradient(
                        ...
                        colors: [Color(0xFF814809), Colors.black])),
                child: Padding(
            ...
            Row(
              ...
              children: [
                    ...
                    child: Container(
                      ...
                      decoration: ShapeDecoration(
                        ...
                        shape: CustomDividerShape(
                            color: Color(0xFFF3B46E), isReversed: true),
                      ),
                    ),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 16.0),
                  child: SvgPicture.asset("assets/svg/dojo_icon.svg",
                      width: 44, height: 32),
                ),
                Expanded(
                  child: Container(
                    ...
                    decoration: ShapeDecoration(
                        color: Color(0xFFF3B46E),
                        shape: CustomDividerShape(color: Color(0xFFF3B46E))),
                  ),
                ),
              ],
            ),
            ...
            MatchResultWidget(
                title: 'LOST',
                value: '11',
                icon: SvgPicture.asset('assets/svg/black_checkers_icon.svg',
                    width: 20, height: 20)),
            verticalSpace(8.0),
            MatchResultWidget(
                title: 'QUEENS',
                value: '2',
                icon:
                    Image.asset("assets/images/queen_checkers.png", width: 20)),
            verticalSpace(8.0),
            MatchResultWidget(
                title: 'WIN',
                value: '11',
                icon: SvgPicture.asset('assets/svg/white_checkers_icon.svg',
                    width: 20, height: 20)),
            Spacer(),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16.0),
              child: SizedBox(
                ...
                child: OutlinedButton(
                  onPressed: () async =>
                      await _game.updatePlayState(PlayState.welcome),
            ...
            Padding(
              padding: const EdgeInsets.only(
                  left: 16.0, right: 16, bottom: 32, top: 8),
