...
class _CreateGameScreenState extends ConsumerState<CreateGameScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(automaticallyImplyLeading: false, title: const BalanceAppBar()),
      body: LayoutBuilder(
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          RadioOption(
                                            ...
                                            borderColor: const Color(0xFF00ECFF),
                                            child:
                                                const Text('2 Players', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400, color: Color(0xFF00ECFF))),
                                          ),
                                          const SizedBox(width: 8),
                                          RadioOption(
                                            width: 110,
                                            ...
                                            borderColor: const Color(0xFF00ECFF),
                                            child:
                                                const Text('4 Players', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400, color: Color(0xFF00ECFF))),
                                          ),
                                        ],
                                      ),
                                    ],
                                              ...
                                              children: [
                                                Expanded(
                                                  child: RadioOption(
                                                    ...
                                                    borderColor: const Color(0xFF00ECFF),
                                                    width: 143,
                                                    padding: const EdgeInsets.only(left: 14, top: 9.5, bottom: 9.5),
                                                    child: Row(
                                                      children: [
                                                        ...
                                                        Text(
                                                          ...
                                                          style: TextStyle(
                                                              ...
                                                              color:
                                                                  _selectedTokenAddress == _supportedTokens["STRK"] ? Colors.black : const Color(0xFF00ECFF)),
                                                        ),
                                                      ],
                                                    ),
                                                  ),
                      ...
                      Expanded(
                        child: ElevatedButton(
                          ...
                          child: _isLoading
                              ...
                              : Text(_activeTab == _numberOfTabs && _playerColor != null ? 'Create Game' : 'Next'),
                        ),
                      ),
                    ],
                  ),
